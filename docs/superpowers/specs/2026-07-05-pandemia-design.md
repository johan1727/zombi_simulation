...
| **Alta** (futuro) | Modelo detallado con animación esquelética real | Solo para los ciudadanos cerca de cámara/seleccionados (LOD); el resto se queda en Media. Requiere blending de animación de verdad — se evalúa cuando Media esté rindiendo bien. Diseño de LOD ya esbozado en `docs/superpowers/plans/2026-07-19-plan-11-animacion-esqueletica-lod.md`. | Plan 11 (pendiente) |
